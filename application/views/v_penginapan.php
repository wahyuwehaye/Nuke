                ...
                <div class="col-md-12">
                    <div class="card card-plain">
                        <div class="card-header" data-background-color="purple">
                            <h4 class="title">Kelola Data Penginapan</h4>
                            <!-- <p class="category">Here is a subtitle for this table</p> -->
                            <button class="btn btn-xs btn-success" onclick="add_penginapan()"><i class="material-icons">add_location</i></button>
                        ...
                        <div class="card-content table-responsive">
                            <table id="table" class="table table-hover">
                                ...
                                <tbody>
                            		...
                            		<tr>
                            			<td><?php echo $no++ ?></td>
                            			<td><?php echo $a->nama_penginapan ?></td>
                            			<td><?php echo $a->alamat_penginapan ?></td>
                            			<td><?php echo $a->kategori_penginapan ?></td>
                                        <?php if (($_SESSION['username'])=='admin') {
