<!-- <div class="single w3l-agileits">
    <div class="container">
    <div class="com">
    <h3>Tentang Boyolali > Warisan Kabupaten Boyolali</h3>
    <ul class="media-list">
      <li class="media">
    ...
    <div class="container">
      ...
      <div class="about-grids">
        <div class="col-md-4 about-grid">
          <img src="<?php echo base_url()?>assets/images/transport.jpg" alt=" " class="img-responsive" />
          <div class="img-bottom">
            <p>Transportasi</p>
          </div>
        </div>
        <div class="col-md-4 about-grid">
          <img src="<?php echo base_url()?>assets/images/wisata.jpg" alt=" " class="img-responsive" />
          <div class="img-bottom">
            <p>Pariwisata</p>
          </div>
        </div>
        <div class="col-md-4 about-grid">
          <img src="<?php echo base_url()?>assets/images/julukan.jpg" alt=" " class="img-responsive" />
          <div class="img-bottom">
            <p>Julukan</p>
          </div>
        </div>
